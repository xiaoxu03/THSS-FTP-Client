...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonlabelCommandInput = QtWidgets.QPushButton(self.widgetCommandInput)
        self.buttonlabelCommandInput.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("AcadEref")
        font.setPointSize(14)
        self.buttonlabelCommandInput.setFont(font)
        self.buttonlabelCommandInput.setObjectName("buttonlabelCommandInput")
        self.horizontalLayout_7.addWidget(self.buttonlabelCommandInput)
        ...
        self.treeFile = QtWidgets.QTreeWidget(self.widgetExploror)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeFile.sizePolicy().hasHeightForWidth())
        self.treeFile.setSizePolicy(sizePolicy)
        self.treeFile.setMinimumSize(QtCore.QSize(0, 200))
        self.treeFile.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.treeFile.setFont(font)
        self.treeFile.setObjectName("treeFile")
        self.treeFile.headerItem().setText(0, "1")
        self.verticalLayout.addWidget(self.treeFile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonlabelCommandInput.setText(_translate("MainWindow", "发送"))
